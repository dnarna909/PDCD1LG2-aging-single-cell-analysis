...
Single-cell or single-nucleus RNA-sequencing datasets in .h5ad format were obtained from publicly available CELLxGENE resources (https://cellxgene.cziscience.com/collections/ff69f0ee-fef6-4895-9f48-6c64a68c8289?explainNewTab). The analysis workflow was designed to evaluate age-associated expression patterns of PDCD1LG2 and selected inflammation-, senescence-, and extracellular matrix-associated genes across human tissue datasets. The primary dataset analyzed in the current workflow was the Healthy pediatric and adult human liver tissue dataset. 
